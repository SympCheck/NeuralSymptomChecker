...
"""Repo for article about symptom checker based on deep learning network with logic regularization file for ensuring the package is executable
as `symptom_cheker_article` and `python -m repo_for_article_about_symptom_checker_based_on_deep_learning_network_with_logic_regularization`
"""
import importlib
