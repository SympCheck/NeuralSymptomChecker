...
from .models import SymptomCheckerLegacy
...
def sympt_checker_legacy_model(**kwargs):
    return base_model_tuning_pipeline(SymptomCheckerLegacy,
                                        'symptom_checker',
                                        SymptToSymptDataset,
                                        'params:common_conf_legacy',
